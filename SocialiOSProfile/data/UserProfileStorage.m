...
static NSString* TAG            = @"SOCIAL UserProfileStorage";
...
+ (void)setUserProfile:(UserProfile *)userProfile andNotify:(BOOL)notify {
    ...
    NSString* value = [SocialUtils dictToJsonString:[userProfile toDictionary]];
...
+ (UserProfile *)getUserProfile:(Provider)provider {
    ...
    NSDictionary* userProfileDict = [SocialUtils jsonStringToDict:userProfileJSON];
