...
/**
 ...
 `SocialEntity` and adds its own behavior on top of it.
 */
...
/** 
 Constructor.
 Generates an instance of `SocialEntity` from an `NSDictionary`.
 
 @param dict An `NSDictionary` representation of the wanted `SocialEntity`.
 */
- (id)initWithDictionary:(NSDictionary*)dict;

/**
 Converts the current `SocialEntity` to an `NSDictionary`.
 
 @return This instance of SocialEntityas an `NSDictionary`.
 */
- (NSDictionary*)toDictionary;

/**
 Tests equality between two `SocialEntity`s
