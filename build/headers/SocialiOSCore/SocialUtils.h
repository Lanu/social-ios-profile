...
#define LogDebug(x,y) [SocialUtils LogDebug:x withMessage:y];
#define LogError(x,y) [SocialUtils LogError:x withMessage:y];
#define IsStringEmpty(x) [SocialUtils isEmpty:x]

/**
 This class handles printing of error and debug messages.
 */
@interface SocialUtils : NSObject
